...
class ClientsCreate(LoginRequiredMixin, UserPassesTestMixin,CreateView):
    model = Client
...
class ClientsDetail(LoginRequiredMixin,UserPassesTestMixin,DetailView):
    model = Client
    form_class = ClientForm
...
class ClientsDelete(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model= Client

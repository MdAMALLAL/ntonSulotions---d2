# Generated by Django 2.2.13 on 2020-07-02 15:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priorite', models.CharField(choices=[('F', 'Low'), ('M', 'Medium'), ('H', 'Height'), ('U', 'Urgent'), ('B', 'Bloquant')], default='F', max_length=1)),
                ...
                ('priorite_intern', models.CharField(choices=[('F', 'Low'), ('M', 'Medium'), ('H', 'Height'), ('U', 'Urgent'), ('B', 'Bloquant')], default='OV', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('EA', 'Waiting'), ('RS', 'Resolved'), ('FR', 'Closed'), ('RF', 'Refused')], default='EA', max_length=2)),
